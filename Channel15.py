...
logDirectory = 'C:/Users/E5/Desktop/Allan LABVIEW/E5 Logger/Channel 15/'

log = TempDisplay(logDirectory, 'Channel 15', columns = ('Channel 15',), title='Channel15', resample=False)
