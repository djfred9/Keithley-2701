...
logDirectory = 'C:/Users/E5/Desktop/Allan LABVIEW/E5 Logger/Channel 14/'

log = TempDisplay(logDirectory, 'Channel 14', columns = ('Channel 14',), title='Channel14', resample=False)
