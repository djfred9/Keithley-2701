...
logDirectory = 'C:/Users/E5/Desktop/Allan LABVIEW/E5 Logger/Channel 19/'

log = TempDisplay(logDirectory, 'Channel 19', columns = ('Channel 19',), title='Channel19', resample=False)
