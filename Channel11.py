...
logDirectory = 'C:/Users/E5/Desktop/Allan LABVIEW/E5 Logger/Channel 11/'

log = TempDisplay(logDirectory, 'Channel 11', columns = ('Channel 11',), title='Channel11', resample=False)
