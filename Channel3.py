...
logDirectory = 'C:/Users/E5/Desktop/Allan LABVIEW/E5 Logger/Channel 3/'

log = TempDisplay(logDirectory, 'Channel 3', columns = ('Channel 3',), title='Channel3', resample=False)
