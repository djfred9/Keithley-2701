...
logDirectory = 'C:/Users/E5/Desktop/Allan LABVIEW/E5 Logger/Channel 13/'

log = TempDisplay(logDirectory, 'Channel 13', columns = ('Channel 13',), title='Channel13', resample=False)
