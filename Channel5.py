...
logDirectory = 'C:/Users/E5/Desktop/Allan LABVIEW/E5 Logger/Channel 5/'

log = TempDisplay(logDirectory, 'Channel 5', columns = ('Channel 5',), title='Channel5', resample=False)
