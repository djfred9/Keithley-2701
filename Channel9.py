...
logDirectory = 'C:/Users/E5/Desktop/Allan LABVIEW/E5 Logger/Channel 9/'

log = TempDisplay(logDirectory, 'Channel 9', columns = ('Channel 9',), title='Channel9', resample=False)
