...
logDirectory = 'C:/Users/E5/Desktop/Allan LABVIEW/E5 Logger/Channel 2/'


log = TempDisplay(logDirectory, 'Channel 2', columns=('Channel 2',), title='Channel 2', resample=False)
