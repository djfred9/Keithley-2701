...
logDirectory = 'C:/Users/E5/Desktop/Allan LABVIEW/E5 Logger/Channel 18/'

log = TempDisplay(logDirectory, 'Channel 18', columns = ('Channel 18',), title='Channel18', resample=False)
