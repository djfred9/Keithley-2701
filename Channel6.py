...
logDirectory = 'C:/Users/E5/Desktop/Allan LABVIEW/E5 Logger/Channel 6/'

log = TempDisplay(logDirectory, 'Channel 6', columns = ('Channel 6',), title='Channel6', resample=False)
