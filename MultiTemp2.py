...
logDirectory = 'C:/Users/E5/Desktop/Allan LABVIEW/E5 Logger/MultiTemp2'

probeNames = ('Channel 102',
              'Bellows',
              '4 Way Cross',
              'Turbo',
              'MOT Coils',
...
log = TempDisplay(logDirectory, 'Channel2', title='MultiTemp2', resample=False)
