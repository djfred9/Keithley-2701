...
logDirectory = 'C:/Users/E5/Desktop/Allan LABVIEW/E5 Logger/Channel 8/'

log = TempDisplay(logDirectory, 'Channel 8', columns = ('Channel 8',), title='Channel8', resample=False)
